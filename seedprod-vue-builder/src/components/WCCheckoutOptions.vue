    ...
    <div v-if="view == 1">
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_1">
        <div class="sp-form-group">
          <label class="sp-w-full">
            <select v-model="block.settings.layoutColumns" class="sp-form-select">
              <option value="1">{{ txt_20 }}</option>
              <option value="2">{{ txt_21 }}</option>
            </select>
          </label>
        </div>
      </div>
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_3">
        ...
        <div class="sp-form-group">
          <TypographyControl :block="block" prefix="label" />
        </div>

        <div class="sp-form-group">
          <label>{{txt_29}}</label>
          <SliderControl v-model="block.settings.rowSpacing" :min="0" :max="30" :step="1" />
        </div>
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_5">
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_38"
            :color="block.settings.alertInfoHlColor"
            v-model="block.settings.alertInfoHlColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_39"
            :color="block.settings.alertErrorHlColor"
            v-model="block.settings.alertErrorHlColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_40"
            :color="block.settings.alertSuccessHlColor"
            v-model="block.settings.alertSuccessHlColor"
          />
        </div>
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_6">
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_41"
            :color="block.settings.cartFieldBorderColor"
            v-model="block.settings.cartFieldBorderColor"
          />
        </div>

        <BorderWidthControl :block="block" prefix="cart" />

        <div class="sp-form-group">
          <label>{{txt_43}}</label>
          <SliderControl v-model="block.settings.cartBorderRadius" :min="0" :max="30" :step="1" />
        </div>

        <div class="sp-form-group">
          <ColorPicker
            :label="txt_44"
            :color="block.settings.cartBgColor"
            v-model="block.settings.cartBgColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            ...
            v-model="block.settings.cartTextColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <label>{{txt_46}}</label>
          <FontControl
            v-model="block.settings.cartFont"
            @change="load_font(block.settings.cartFont,block.settings.cartFontVariant)"
          />
          <FontVariantControl
            v-model="block.settings.cartFontVariant"
            :myfont="block.settings.cartFont"
            @change="load_font(block.settings.cartFont,block.settings.cartFontVariant)"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_47"
            :color="block.settings.cartHeaderBgColor"
            v-model="block.settings.cartHeaderBgColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <label>{{txt_48}}</label>
          <FontControl
            v-model="block.settings.cartHeaderFont"
            @change="load_font(block.settings.cartHeaderFont,block.settings.cartHeaderFontVariant)"
          />
          <FontVariantControl
            v-model="block.settings.cartHeaderFontVariant"
            :myfont="block.settings.cartHeaderFont"
            @change="load_font(block.settings.cartHeaderFont,block.settings.cartHeaderFontVariant)"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_49"
            :color="block.settings.cartHeaderColor"
            v-model="block.settings.cartHeaderColor"
          />
        </div>
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_7">
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_44"
            :color="block.settings.paymentBgColor"
            v-model="block.settings.paymentBgColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <ColorPicker
            :label="txt_45"
            :color="block.settings.paymentTextColor"
            v-model="block.settings.paymentTextColor"
          />
        </div>
        ...
        <div class="sp-form-group">
          <label>{{txt_46}}</label>
          <FontControl
            v-model="block.settings.paymentFont"
            @change="load_font(block.settings.paymentFont,block.settings.paymentFontVariant)"
          />
          <FontVariantControl
            v-model="block.settings.paymentFontVariant"
            :myfont="block.settings.paymentFont"
            @change="load_font(block.settings.paymentFont,block.settings.paymentFontVariant)"
          />
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      txt_100: __( 'Default', process.env.VUE_APP_TEXTDOMAIN ),
      view: 1,
      section_1: true,
      section_2: false,
      section_3: false,
