    ...
    <div v-if="view == 1">
      ...
      <div class="seedprod-sidebar-action-body" v-if="section_1">
        ...
        <div class="sp-form-group">
          <label>{{txt_5}}</label>
          <SliderControl v-model="block.settings.width" :min="400" :max="1000" :step="10" />
        </div>

        <div class="sp-form-group">
          <label>{{txt_6}}</label>
          <SliderControl v-model="block.settings.colGutter" :min="0" :max="50" :step="1" />
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      txt_3: __( 'Background', process.env.VUE_APP_TEXTDOMAIN ),
      txt_4: __( 'Styles', process.env.VUE_APP_TEXTDOMAIN ),
      txt_5: __( 'Width', process.env.VUE_APP_TEXTDOMAIN ),
      txt_6: __( 'Column Gutter', process.env.VUE_APP_TEXTDOMAIN ),
      ...
      txt_15: __( 'Background Color', process.env.VUE_APP_TEXTDOMAIN ),
      view: 1,
      section_1: true,
      section_2: false,
      section_3: false,
