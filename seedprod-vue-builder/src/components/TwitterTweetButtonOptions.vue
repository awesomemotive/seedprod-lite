      ...
      >
        ...
        <div class="sp-form-group">
          ...
          <input
            :name="'Url'"
            type="text"
            v-model="block.settings.tweetUrl"
        ...
        <div class="sp-form-group">
          ...
          <input
            :name="'Tweet Text'"
            type="text"
            v-model="block.settings.tweetText"
            class="sp-form-input sp-w-full"
          >
        </div>
        ...
        <div class="sp-form-group">
          ...
          <input
            :name="'Hashtags'"
            type="text"
            v-model="block.settings.tweetHashTag"
            class="sp-form-input sp-w-full"
          >
        </div>
        ...
        <div class="sp-form-group">
          ...
          <input
            :name="'Via'"
            type="text"
            v-model="block.settings.viaHandle"
            class="sp-form-input sp-w-full"
          >
        </div>
        ...
        <div class="sp-form-group">
          ...
          <input
            :name="'Related'"
            type="text"
            v-model="block.settings.relatedTweet"
            class="sp-form-input sp-w-full"
          >
        </div>
...
export default {
  name: 'TwitterTweetButtonOptions',
  mixins: [ helpers ],
  inject: {
    $validator: '$validator',
  },
  data() {
    return {
      ...
      txt_9: __( 'Url', process.env.VUE_APP_TEXTDOMAIN ),
      txt_10: __( 'Text', process.env.VUE_APP_TEXTDOMAIN ),
      txt_11: __( 'Hashtags', process.env.VUE_APP_TEXTDOMAIN ),
      txt_12: __( 'Via', process.env.VUE_APP_TEXTDOMAIN ),
      txt_13: __( 'Related', process.env.VUE_APP_TEXTDOMAIN ),
  ...
  mounted() {
    ...
    setTimeout( function() {
      twttr.widgets.load(
            document.getElementById('sp-twittertweetbutton-builder-' + self.block.id)
      );
    }, 600 );

    /*
    setTimeout( function() {
      self.onTwitterTweetButtonChange();
      //twttr.widgets.load();
    }, 500 );
    */
  ...
  methods: {
    onTwitterTweetButtonChange() {

          document.getElementById( 'sp-twittertweetbutton-builder-' + this.block.id ).innerHTML = '';

          window.twttr.widgets.createShareButton(
              this.block.settings.tweetUrl,
              document.getElementById('sp-twittertweetbutton-builder-' + this.block.id),
              {
                size: this.block.settings.buttonSize,
                text:  this.block.settings.tweetText,
                hashtags: this.block.settings.tweetHashTag,
                via: this.block.settings.viaHandle,
                related: this.block.settings.relatedTweet,
                lang : this.block.settings.lang,
              }
          );
  ...
  watch: {
      'block.settings.tweetUrl': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
      'block.settings.buttonSize': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
      'block.settings.tweetText': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
      'block.settings.tweetHashTag': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
      'block.settings.viaHandle': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
      'block.settings.relatedTweet': function( newVal, oldVal ) {
        this.onTwitterTweetButtonChange();
      },
