      ...
      <div class="seedprod-sidebar-action-body" v-if="section_4">
        ...
        <div class="sp-form-group">
          ...
          <select v-model="block.settings.textShadow" class="sp-form-select">
            <option value>{{txt_9}}</option>
            <option value="1">{{txt_10}}</option>
            <option value="2">{{txt_11}}</option>
            <option value="3">{{txt_12}}</option>
            <option value="4">{{txt_13}}</option>
            <option value="5">{{txt_14}}</option>
            <option value="6">{{txt_15}}</option>
          </select>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      txt_3: __( 'Text', process.env.VUE_APP_TEXTDOMAIN ),
      txt_4: __( 'Styles', process.env.VUE_APP_TEXTDOMAIN ),
      txt_5: __( 'Text', process.env.VUE_APP_TEXTDOMAIN ),
      txt_6: __( 'Align', process.env.VUE_APP_TEXTDOMAIN ),
      txt_7: __( 'Font Size', process.env.VUE_APP_TEXTDOMAIN ),
      txt_8: __( 'Text Shadow', process.env.VUE_APP_TEXTDOMAIN ),
      txt_9: __( 'None', process.env.VUE_APP_TEXTDOMAIN ),
      txt_10: __( 'Hairline', process.env.VUE_APP_TEXTDOMAIN ),
      txt_11: __( 'Small', process.env.VUE_APP_TEXTDOMAIN ),
      txt_12: __( 'Medium', process.env.VUE_APP_TEXTDOMAIN ),
      txt_13: __( 'Large', process.env.VUE_APP_TEXTDOMAIN ),
      txt_14: __( 'X Large', process.env.VUE_APP_TEXTDOMAIN ),
      txt_15: __( '2X Large', process.env.VUE_APP_TEXTDOMAIN ),
      txt_16: __( 'Shadow', process.env.VUE_APP_TEXTDOMAIN ),
      txt_17: __( 'Background Color', process.env.VUE_APP_TEXTDOMAIN ),
      txt_18: __( 'Color', process.env.VUE_APP_TEXTDOMAIN ),
      txt_19: __( 'Insert Dynamic Text', process.env.VUE_APP_TEXTDOMAIN ),
      view: 1,
      section_1: true,
      section_2: false,
      section_3: false,
