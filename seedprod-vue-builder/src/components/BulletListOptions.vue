          ...
          <draggable :list="block.settings.items" handle=".sp-drag-drop">
            ...
            >
              <div class="sp-flex sp-items-center">
                ...
                >
                  <span>
                    <IconPicker v-model="item.icon" type="min" />
                  </span>

                  <span
                    v-text="item.txt"
                    class="sp-rounded-tl-none sp-rounded-bl-none sp-form-input sp-border-none sp-drag-drop sp-cursor-move sp-truncate"
                    style="width:160px"
...
export default {
  ...
  data() {
    return {
      ...
      txt_3: __( 'List', process.env.VUE_APP_TEXTDOMAIN ),
      ...
      txt_18: __( 'Icon Color', process.env.VUE_APP_TEXTDOMAIN ),
