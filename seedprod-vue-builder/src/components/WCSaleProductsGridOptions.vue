<template>
  <WCCustomProductsGridOptions :block="block" :type="'wcsaleproductsgrid'" />
</template>
...
export default {
  name: 'WCSaleProductsGridOptions',
  mixins: [ helpers ],
  inject: {
  },
  data() {
  ...
  mounted() {
    let self = this;
    lodash.forOwn( this.shared.block_templates.wcsaleproductsgrid, function( value, key ) {
