      ...
      <div class="seedprod-sidebar-action-body" v-if="section_1">
        <div class="sp-form-group">
          ...
          <input
            :name="'location'"
            type="text"
            v-model="block.settings.location"
        ...
        <div class="sp-form-group">
          <label>{{txt_3}}</label>
          <SliderControl v-model="block.settings.zoom" :min="0" :max="20" :step="1" />
        </div>

        <div class="sp-form-group">
            <label>{{txt_10}}</label>
            <SliderControl v-model="block.settings.width" :min="0" :max="100" :step="1" />
        </div>

        <!-- <div class="sp-form-group">
            <label>{{txt_4}}</label>
            <SliderControl v-model="block.settings.height" :min="0" :max="1000" :step="1" />
        </div> -->
...
export default {
  ...
  data() {
    return {
      txt_1: __("Google Maps", process.env.VUE_APP_TEXTDOMAIN),
      txt_2: __("Location", process.env.VUE_APP_TEXTDOMAIN),
      txt_3: __("Zoom", process.env.VUE_APP_TEXTDOMAIN),
      txt_4: __("Height", process.env.VUE_APP_TEXTDOMAIN),
      txt_5: __("Content", process.env.VUE_APP_TEXTDOMAIN),
      txt_6: __("Advanced", process.env.VUE_APP_TEXTDOMAIN),
      txt_7: __("Styles", process.env.VUE_APP_TEXTDOMAIN),
  ...
  mounted() {
    let self = this;
    lodash.forOwn(this.shared.block_templates.googlemaps, function(value, key) {
