...
( function( $ ) {
  ...
  function isInEffect( effect ) {
    return /In/.test( effect ) || 0 <= $.inArray( effect, $.fn.textillate.defaults.inEffects );
  }

  function isOutEffect( effect ) {
    return /Out/.test( effect ) || 0 <= $.inArray( effect, $.fn.textillate.defaults.outEffects );
  }
  ...
  let Textillate = function( element, options ) {
    ...
    base.init = function() {
      ...
      base.$current = $( '<span class="sp-textillate">' )
    ...
    base.in = function( index, cb ) {
      ...
      let $elem = base.$texts.find( ':nth-child(' + ( ( index || 0 ) + 1 ) + ')' ),
        options = $.extend( true, {}, base.options, $elem.length ? getData( $elem[0]) : {}),
        $tokens;

	  let sparklineElement = base.$current.closest( '.sp-animated-texts-wrapper' );
    ...
    base.out = function( cb ) {
      let $elem = base.$texts.find( ':nth-child(' + ( ( base.currentIndex || 0 ) + 1 ) + ')' ),
      ...
      setTimeout( function() {
        ...
        ( function run( index ) {
          base.in( index, function() {
            let length = base.$texts.children().length;
  ...
  $.fn.textillate = function( settings, args ) {
    return this.each( function() {
      let $this = $( this ),
        ...
        options = $.extend( true, {}, $.fn.textillate.defaults, getData( this ), 'object' == typeof settings && settings );
